...
public class TetherSettings extends SettingsPreferenceFragment
    ...
    public void onCreate(Bundle icicle) {
        ...
        String prefString = Utils.replaceAllWiFi(mEnableWifiAp.getTitle().toString());
    ...
    private void initWifiTethering() {
        ...
        String prefString = Utils.replaceAllWiFi(mCreateNetwork.getTitle().toString());
        String prefStringSummary = Utils.replaceAllWiFi(mCreateNetwork.getSummary().toString());
